...
import math
import numpy as np
from modules.randomScene import create_random_benchmark
...
description = "Planner has to find a narrow passage with a significant extend."
...
my_random_benchmark = create_random_benchmark(
    scene_limits=scene_bounds,
    name="Random Map",
    level=2,
    n_polygons=6,
    n_strings=3,
...
benchList.append(my_random_benchmark)